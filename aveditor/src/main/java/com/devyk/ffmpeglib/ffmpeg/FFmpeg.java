 ...
 * asynchronous {@link #executeAsync(String, com.devyk.ffmpeglib.callback.ExecuteCallback)} methods to execute FFmpeg commands.
 * <pre>
...
public class FFmpeg {
   ...
   public static final long DEFAULT_EXECUTION_ID = 0;
     ...
     */
    public static long executeAsync(final String[] arguments, final com.devyk.ffmpeglib.callback.ExecuteCallback executeCallback) {
     ...
     * @return returns a unique id that represents this execution
     */
    public static long executeAsync(final String[] arguments, long duration, final com.devyk.ffmpeglib.callback.ExecuteCallback executeCallback, final Executor executor) {
        final long newExecutionId = executionIdCounter.incrementAndGet();
     ...
     * @return returns a unique id that represents this execution
     */
    public static long executeAsync(final String command, final com.devyk.ffmpeglib.callback.ExecuteCallback executeCallback) {
        final long newExecutionId = executionIdCounter.incrementAndGet();
    ...
    public static long executeAsync(final String command, long videoduration,final com.devyk.ffmpeglib.callback.ExecuteCallback executeCallback) {
        final long newExecutionId = executionIdCounter.incrementAndGet();
    ...
    public static long executeAsync(String[] cmds, long duration, com.devyk.ffmpeglib.callback.ExecuteCallback executeCallback) {
        final long newExecutionId = executionIdCounter.incrementAndGet();
    ...
    public static void cancel() {
        com.devyk.ffmpeglib.config.Config.nativeFFmpegCancel(DEFAULT_EXECUTION_ID);
    }
    ...
    public static void cancel(final long executionId) {
        com.devyk.ffmpeglib.config.Config.nativeFFmpegCancel(executionId);
    }
    ...
    public static List<FFmpegExecution> listExecutions() {
        return com.devyk.ffmpeglib.config.Config.listFFmpegExecutions();
    }
